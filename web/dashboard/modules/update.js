...
/* The one mutable view-model. Rendering is a pure function of this. */
...
function setProgress(message) {
  ...
  if (p && view.phase === 'progress') { p.textContent = message; return; }
  render();
}
...
async function applyUpdate() {
  const btn = document.querySelector('[data-update-apply]');
